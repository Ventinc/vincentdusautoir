...
date: "2023-11-01"
image: /images/blog/svg-icons.png
published: true
---
...
<Callout>
  **cn** is a function that combine `tailwind-merge` (Utility function to
  ...
  [here](https://github.com/Ventinc/vincentdusautoir/blob/main/src/utils/tailwind.ts)
</Callout>
...
<ComponentExample
  ...
  filesrc="/components/examples/svg-icon/default-example.tsx"
>
  <DefaultIconExample />
</ComponentExample>
...
<ComponentExample
  title="As a child Example"
  filesrc="/components/examples/svg-icon/slot-example.tsx"
>
  <SlotIconExample />
</ComponentExample>
...
<ComponentExample
  title="createIcon Example"
  filesrc="/components/examples/svg-icon/create-icon-example.tsx"
>
