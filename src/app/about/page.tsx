    ...
    <div className="container">
      ...
      <div className="grid grid-flow-row grid-cols-8 gap-4">
        <div className="col-span-8 rounded-2xl p-4 lg:col-span-5">
          ...
          <Text>
            I was born in 1997 in Marcq-En-Baroeul, France. After seing my uncle
            typing some characters on his computer and make a website, I started
            to learn about computer science and programming at 14 years old.
          </Text>
          <Text>
            Since there I love tech challenges and challenging myself throught a
            lot of different problems.
          </Text>
          <Text>
            Except programming I love to travel, discover new countries, new
            people and differents cultures. I love taking pictures or videos to
            keep memory of past experiences I had.
          </Text>
          <Text>
